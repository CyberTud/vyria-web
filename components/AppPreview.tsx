    ...
    <section ref={sectionRef} id="app" className="py-24 md:py-32 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="app-preview-header text-center mb-16">
          <div className="inline-block px-4 py-2 bg-green-100 border border-green-200 rounded-lg mb-4">
            <span className="text-sm font-semibold text-green-900 uppercase tracking-wide">Available Now</span>
          </div>
          ...
          <div className="flex items-center justify-center gap-4 mb-8">
            <a 
              ...
              className="flex items-center gap-2 px-4 py-2 bg-white border-2 border-gray-200 rounded-lg hover:border-yellow-500 hover:shadow-lg transition-all"
            >
            ...
            <div className="relative flex items-center gap-2 px-4 py-2 bg-gray-100 border-2 border-gray-200 rounded-lg opacity-75">
              <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
